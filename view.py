...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.nodeInput.setItemText(2, _translate("Dialog", "Bomb Node(Diffuse me first)"))
        self.nodeInput.setItemText(3, _translate("Dialog", "Weighted Node"))
        self.nodeInput.setItemText(4, _translate("Dialog", "Unweighted Node"))
